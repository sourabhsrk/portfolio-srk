...
const Experience = ({experiences}: Props) => {
  ...
  return (
    <div className='relative flex flex-col h-screen text-center items-center md:justify-center md:text-left md:flex-row md:overflow-hidden
    max-w-full md:px-10 px-4 pt-32 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80'>
